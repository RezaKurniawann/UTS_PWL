        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('/level/import') }}')" class="btn btn-sm btn-info mt-1">
                    <i class="fa fa-upload"></i> Impor Level
                </button>
                <a href="{{ url('/level/export_excel') }}" class="btn btn-primary">
                    <i class="fa fa-file-excel"></i> Export Level Excel
                </a>
                <a href="{{ url('/level/export_pdf') }}" class="btn btn-primary">
                    <i class="fa fa-file-pdf"></i> Export Level PDF
                </a>
