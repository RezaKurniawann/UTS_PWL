...
<head>
    ...
    <style>
        ...
        .main-sidebar {
            background: linear-gradient(135deg, #f5e0c3, #e4b47d);
        }
        .brand-link,
        .brand-text {
            color: #783b31 !important; /* Icon and text color */
        }
        .nav-link {
            color: #783b31 !important; /* Sidebar link color */
        }
        .nav-link:hover {
            color: #b3846c !important; /* Hover effect for sidebar links */
        }
        .nav-icon {
            color: #783b31 !important; /* Icon color */
        }
        .nav-icon:hover {
            color: #b3846c !important; /* Icon color */
        }
    </style>
</head>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/') }}" class="brand-link d-flex align-items-center">
                <i class="fas fa-bread-slice brand-image" style="font-size: 24px; margin-right: 8px;"></i> 
                <span class="brand-text font-weight-light">AwanBakery</span>
            </a>
