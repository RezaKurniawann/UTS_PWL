        ...
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('/kategori/import') }}')" class="btn btn-sm btn-info mt-1">
                    <i class="fa fa-upload"></i> Impor Kategori
                </button>
                <a href="{{ url('/kategori/export_excel') }}" class="btn btn-primary">
                    <i class="fa fa-file-excel"></i> Export Kategori Excel
                </a>
                <a href="{{ url('/kategori/export_pdf') }}" class="btn btn-primary">
                    <i class="fa fa-file-pdf"></i> Export Kategori PDF
                </a>
